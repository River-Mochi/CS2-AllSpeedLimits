    ...
    const renderSpeedStepButton = (direction: number, label: string | undefined) => {
        ...
        return (
            <button
                ...
                onClick={() => onStepClickFallback(direction, disabled)}
                onKeyDown={event => {
                ...
                style={{
                    ...
                    backgroundColor: disabled ? "rgba(255, 255, 255, 0.035)" : "rgba(255, 255, 255, 0.08)",
                    borderWidth: "1rem",
                    borderStyle: "solid",
                    borderColor: disabled ? "rgba(255, 255, 255, 0.04)" : "rgba(255, 255, 255, 0.14)",
                    borderRadius: "4rem",
